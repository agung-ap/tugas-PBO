...
public class AdminCourse implements Initializable {
    ...
    /**
     * FXCollection class yang digunakan dalam javafx untuk mengambil data dari database
     * @param query
     * @return
     */
     ...
     * button add new course di click
     */
